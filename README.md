...
This is a sample template for geolocation - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name geolocation --tail
```
